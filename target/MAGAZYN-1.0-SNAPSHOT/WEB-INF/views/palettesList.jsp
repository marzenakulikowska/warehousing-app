        ...
        <ul class="responsive-table">
            ...
            <c:forEach items="${palettes}" var="palette">
                <li class="table-row">
                    ...
                    <div class="col-8"><a href="/warehousing/form/palette/edit/${palette.id}" class="button" style="background-color:#42cc8c;">Edytuj</a></div>
                    <div class="col-8"><a href="/warehousing/form/palette/delete/${palette.id}" class="button" style="background-color:#42cc8c;">Usuń</a></div>
                </li>
            </c:forEach>
        </ul>
    </div>
